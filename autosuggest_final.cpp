...
int main()
{
	...
	fclose(fptr);
	printf("\n\n\n");
  char x[50][20]={"able", "acid", "aged", "also", "cast", "cats","does", "dogs", "done", "door", "gray", "grey", "grow", "jump", "jury", "just", "lack", "land", "lady", "last", "lazy", "ugly", "unit", "upon"};
  char sent[15][20];
  bool f=false;
